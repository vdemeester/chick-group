...
| [`pi-coding-agent`](https://github.com/badlogic/pi-mono) | `0.59.0` | `aarch64-darwin`, `aarch64-linux`, `x86_64-darwin`, `x86_64-linux` |
| [`raffi`](https://github.com/chmouel/raffi) | `0.20.0` | `aarch64-linux`, `x86_64-linux` |
| [`startpaac`](https://github.com/chmouel/startpaac) | `20260317.0` | `aarch64-darwin`, `aarch64-linux`, `x86_64-darwin`, `x86_64-linux` |
