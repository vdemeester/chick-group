...
| [`pac-metrics-watch`](https://github.com/pipelines-as-code/pac-metrics-watch) | `20260320.0` | `aarch64-darwin`, `aarch64-linux`, `x86_64-darwin`, `x86_64-linux` |
| [`pi-acp`](https://github.com/svkozak/pi-acp) | `0.0.23` | `aarch64-darwin`, `aarch64-linux`, `x86_64-darwin`, `x86_64-linux` |
| [`pi-coding-agent`](https://github.com/badlogic/pi-mono) | `0.62.0` | `aarch64-darwin`, `aarch64-linux`, `x86_64-darwin`, `x86_64-linux` |
