...
| [`go-size-analyzer`](https://github.com/Zxilly/go-size-analyzer) | `1.12.5` | `aarch64-darwin`, `aarch64-linux`, `x86_64-darwin`, `x86_64-linux` |
...
| [`pi-coding-agent`](https://github.com/badlogic/pi-mono) | `0.70.5` | `aarch64-darwin`, `aarch64-linux`, `x86_64-darwin`, `x86_64-linux` |
