...
| [`pi-coding-agent`](https://github.com/badlogic/pi-mono) | `0.63.0` | `aarch64-darwin`, `aarch64-linux`, `x86_64-darwin`, `x86_64-linux` |
| [`raffi`](https://github.com/chmouel/raffi) | `0.20.0` | `aarch64-linux`, `x86_64-linux` |
| [`shotty`](https://github.com/vdemeester/shotty) | `0.1.0` | `aarch64-linux`, `x86_64-linux` |
